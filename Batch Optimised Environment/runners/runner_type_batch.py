...
from Signatures.ecdsa_batch import ECDSASignature
...
def run_experiment(mode, n_txs, block_size, verify_mode="scheme", verify_correctness=True, out_dir=None):
    ...
    summary = {
        ...
        "verify_mode_description": (
            ...
            else "batch verification during block commit"
        ...
        "notes": {
            ...
            # "commit_mode": "scheme_verify_seconds_total is zero; commit_seconds_total includes batch signature verification during commit",
...
if __name__ == "__main__":
    run_experiment(
        mode="classical",  # "classical", "pq", or "hybrid"
        n_txs=1000000,
        block_size=1000,
        verify_mode="commit",   # changed from "scheme" — batches all sigs per block before verifying
